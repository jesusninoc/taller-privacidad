...
### Reto 2: Inspección de Storage (100 pts)
- **Instrucción:** Encuentra qué dato sensible ha dejado simuladamente la aplicación en `localStorage` o en las `cookies` no protegidas.

### Reto 3: Análisis de Tráfico Third-Party (100 pts)
